	...
	$list = (new CList())
		...
		->addItem([
			...
			(new CSpan())
				...
				->addItem(
					new CLink($name, (new CUrl('netafier.php'))
	...
	if ($parent_sysmaps) {
		...
		foreach ($parent_sysmaps as $parent_sysmap) {
			$parent_maps->addItem((new CSpan())->addItem(
				new CLink($parent_sysmap['name'], (new CUrl('netafier.php'))
					->setArgument('action', 'map.view')
...
function getAdministrationGeneralSubmenu() {
	$gui_url = (new CUrl('netafier.php'))
		->setArgument('action', 'gui.edit')
		->getUrl();

	$autoreg_url = (new CUrl('netafier.php'))
		->setArgument('action', 'autoreg.edit')
		->getUrl();

	$housekeeping_url = (new CUrl('netafier.php'))
		->setArgument('action', 'housekeeping.edit')
		->getUrl();

	$image_url = (new CUrl('netafier.php'))
		->setArgument('action', 'image.list')
		->getUrl();

	$iconmap_url = (new CUrl('netafier.php'))
		->setArgument('action', 'iconmap.list')
		->getUrl();

	$regex_url = (new CUrl('netafier.php'))
		->setArgument('action', 'regex.list')
		->getUrl();

	$macros_url = (new CUrl('netafier.php'))
		->setArgument('action', 'macros.edit')
		->getUrl();

	$valuemap_url = (new CUrl('netafier.php'))
		->setArgument('action', 'valuemap.list')
		->getUrl();

	$workingtime_url = (new CUrl('netafier.php'))
		->setArgument('action', 'workingtime.edit')
		->getUrl();

	$trigseverity_url = (new CUrl('netafier.php'))
		->setArgument('action', 'trigseverity.edit')
		->getUrl();

	$trigdisplay_url = (new CUrl('netafier.php'))
		->setArgument('action', 'trigdisplay.edit')
		->getUrl();

	$modules_url = (new CUrl('netafier.php'))
		->setArgument('action', 'module.list')
		->getUrl();

	$miscconfig_url = (new CUrl('netafier.php'))
