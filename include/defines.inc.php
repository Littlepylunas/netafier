...
define('NETAFIER_VERSION',		'5.0.2');
define('NETAFIER_API_VERSION',	'5.0.2');
define('NETAFIER_EXPORT_VERSION',	'5.0');
define('NETAFIER_DB_VERSION',		5000000);

define('NETAFIER_COPYRIGHT_FROM',	'2001');
define('NETAFIER_COPYRIGHT_TO',	'2020');
...
define('ZBX_AUTH_FORM_NETAFIER',	0);
...
define('AUDIT_RESOURCE_NETAFIER_CONFIG',		2);
...
define('ITEM_TYPE_NETAFIER_ACTIVE',	7);
...
define('USER_TYPE_NETAFIER_USER',		1);
define('USER_TYPE_NETAFIER_ADMIN',	2);
...
define('ZBX_DEFAULT_AGENT', 'Netafier');
...
define('ZBX_DEFAULT_URL', 'netafier.php?action=dashboard.view');
